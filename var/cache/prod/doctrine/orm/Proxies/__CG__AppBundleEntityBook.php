...
class Book extends \AppBundle\Entity\Book implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Book' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Book' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Book' . "\0" . 'publishingYear', '' . "\0" . 'AppBundle\\Entity\\Book' . "\0" . 'isbn', '' . "\0" . 'AppBundle\\Entity\\Book' . "\0" . 'pageCount', '' . "\0" . 'AppBundle\\Entity\\Book' . "\0" . 'cover', '' . "\0" . 'AppBundle\\Entity\\Book' . "\0" . 'authors'];
        }
    ...
    public function setPublishingYear($publishingYear)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPublishingYear', [$publishingYear]);

        return parent::setPublishingYear($publishingYear);
    }
    ...
    public function getPublishingYear()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPublishingYear', []);

        return parent::getPublishingYear();
    }
