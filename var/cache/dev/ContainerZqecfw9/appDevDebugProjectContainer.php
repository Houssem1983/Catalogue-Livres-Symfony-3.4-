...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = [
            ...
            'appbundle\\form\\authortype' => 'AppBundle\\Form\\AuthorType',
        ...
        $this->fileMap = [
            'AppBundle\\Controller\\AuthorController' => 'getAuthorControllerService.php',
            ...
            'AppBundle\\Form\\AuthorType' => 'getAuthorTypeService.php',
            ...
            'service_locator.abok9wb' => 'getServiceLocator_Abok9wbService.php',
            'service_locator.yoixrmo' => 'getServiceLocator_YoixrmoService.php',
        ...
        $this->privates = [
            ...
            'AppBundle\\Form\\AuthorType' => true,
            ...
            'service_locator.abok9wb' => true,
            'service_locator.yoixrmo' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('eTBOiJG8I-', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6c+5Ugn-GU', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2dh33FGE+f', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kESqm5RhSf', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FyJvm4ub-t', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'covers_directory': $value = ($this->targetDirs[3].'/web/uploads/covers'); break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'houssem',
            'swiftmailer.mailer.default.transport.smtp.password' => 'houssem',
