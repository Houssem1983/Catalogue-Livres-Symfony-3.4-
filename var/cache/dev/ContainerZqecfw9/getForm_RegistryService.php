...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['AppBundle\\Form\\AuthorType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\AuthorType']) ? $this->services['AppBundle\\Form\\AuthorType'] : ($this->services['AppBundle\\Form\\AuthorType'] = new \AppBundle\Form\AuthorType())) && false ?: '_'};
}, 'AppBundle\\Form\\BookType' => function () {
